"""template_tasks_25879 URL Configuration
...
admin.site.site_header = "template-tasks"
admin.site.site_title = "template-tasks Admin Portal"
admin.site.index_title = "template-tasks Admin"

# swagger
api_info = openapi.Info(
    title="template-tasks API",
    default_version="v1",
    description="API documentation for template-tasks App",
)
